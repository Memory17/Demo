    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" value="{{ old('post_title') }}" name="post_title" class="form-control">
                    @error('post_title')
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="">
                    ...
                    @enderror
                    <br>    
                    <img src="../libs/image_no.png" id="image" style="width:200px" alt="Ảnh bài viết">
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <textarea name="post_content" id="my-editor-1" cols="30" rows="10" class="ckeditor">{{old('post_content')}}</textarea>
                    @error('post_content')
                      <span class="text-danger">{{$message}}</span>
                    @enderror
                  </div>
          ...
          <button type="submit" class="btn btn-primary pull-right button_add_ship">Thêm Bài Viết</button>
